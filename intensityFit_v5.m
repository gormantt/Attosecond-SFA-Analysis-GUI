function [E_GD,GD_sub,GD_exp_err,lambda,I0_m]=intensityFit_v5(fname_in,Imin,Imax,Istep,Ip_in,fit_range,filt_phase,at_delay_mcc,det_Ip,fix_int_check_val)
...
%v5:  This includes an input of 1 or 0 that allow one to
...
%% Intensity scan %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    [~,ind]             =   min(Err);
    I0_m                =   I0(ind);
    if fix_int_check_val == 0 %% this was added in v5 to accomodate the fixed intensity option in the SFA_GUI.
