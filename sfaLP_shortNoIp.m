classdef sfaLP_shortNoIp < sfaLPsolver
...
%% Methods %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    methods
function obj = sfaLP_shortNoIp(sfaParam)
% Constructor
...
function [t0,tr,p] = saddlePointSolution (obj,sfaParam,Freq)
    ...
    for k=1:numel(Freq)
        if Freq(k) < sfaParam.Ip
            ...
            warning('sfaLP:sfaLP_shortNoIp:BelowThreshold','Below threshold trajectories are not defined, NaN returned instead');
