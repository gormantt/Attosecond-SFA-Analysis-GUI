function [variables fileinfo]=SifDetails(fid)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
   ...
   %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    for j=1:str2double(variables{134,1})
        ...
        variables{143,2}='horizontal_bin';
        variables(143,1)=readword(fid);

        variables{144,2}='subimage_offset';
        variables(144,1)=readline(fid);
        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    end
...
dimX = dimX/str2double(variables{143,1});
dimY=str2double(variables{139,1})-str2double(variables{141,1})+1;
dimY = dimY/str2double(variables{142,1});
